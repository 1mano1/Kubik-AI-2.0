...
def main(cfg):
    ...
    # Note: We are not passing load_dir or resume steps for this simple script
    trainer = trainer_class(model_dict, dataset, **cfg.trainer.args, output_dir=cfg.output_dir)
